...
var monthsDiv = $(document.createElement('div'));
			...
			switch(this.options.style)
			{
				case 'border':
					...
					if(events.length == 1) {
						...
						elt.css('box-shadow', 'inset 0 -4px 0 0 black');
					}
					...
					if(weight > 0)
					{
						...
						elt.css('box-shadow', boxShadow);
					}
					break;
			
				case 'background':
					elt.css('background-color', events[events.length - 1].color);
					elt.css('border-radius','15px');
					elt.css('color','#FFF');
					break;
			}
		},
		...
		_refreshRange: function () {
            ...
            this.element.find('div.day.range').removeClass('range')
            this.element.find('div.day.range-start').removeClass('range-start');
            this.element.find('div.day.range-end').removeClass('range-end');
